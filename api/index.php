...
<head>
    ...
    <title>Thunder AI - Advanced AI System</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="intro-screen" id="introScreen">
        <div class="logo-container">
            ...
            <h1 class="system-name">Thunder AI</h1>
        </div>
    ...
    <div class="main-interface" id="mainInterface">
        <header class="header">
            <div class="header-logo">Thunder AI</div>
        ...
        <div class="ai-container">
            ...
            <div class="chat-container" id="chatContainer">
                <div class="message ai">
                    <div class="message-label">Thunder AI</div>
                    <div class="message-content">
                        Greetings, Sir. I am Thunder AI, your advanced personal assistant. I'm here to help you with coding, research, creative tasks, and much more. How may I serve you today?
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function addMessage(content, isUser = false) {
            ...
            messageDiv.innerHTML = `
                <div class="message-label">${isUser ? 'You' : 'Thunder AI'}</div>
